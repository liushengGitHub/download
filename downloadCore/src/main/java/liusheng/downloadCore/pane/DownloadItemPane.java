...
public class DownloadItemPane extends VBox {
    ...
    public DownloadItemPane(DownloaderController local) {
        ...
        bottom.getChildren().addAll(cancel
                , pause);
        ...
        BindUtils.bind(cancel.prefWidthProperty(), bottom.widthProperty().multiply(0.5));
        BindUtils.bind(pause.prefWidthProperty(), bottom.widthProperty().multiply(0.5));
