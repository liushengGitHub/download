...
public class DownloadListDialog {
    ...
    public void showAndWait() {
        ...
        JFXComboBox<Label> quality = new JFXComboBox<>();
        quality.getItems().addAll(new Label("low"));
        quality.getItems().addAll(new Label("mid"));
        quality.getItems().addAll(new Label("high"));
        quality.getItems().addAll(new Label("super high"));
        ...
        downloadProcessor.before(alert,quality,listView,downloadingPaneContainer);
        ok.setOnAction(e -> {
            downloadProcessor.processor(alert, quality, listView,downloadingPaneContainer);
        });
